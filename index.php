...
<body>
    ...
    <header>
        <div class="header-top flex">
            <div class="logo">
                <a href="#">
                    <img src="https://cdn.discordapp.com/attachments/993958951181897738/1001186343168245851/logoGoogle.png" alt="logo">
                </a>
            </div>
    ...
    <main>
        <div class="container">
            <?php foreach($frequentQuestionsArray as $frequentQuestion) { ?>
                <h2>
                    <?php echo $frequentQuestion["question"]; ?>
                </h2>
                <?php foreach($frequentQuestion["answer"] as $answerKey => $thisAnswer) { ?>
                    <?php if(!is_array($thisAnswer)) { ?>
                        <p>
                            <?php echo $thisAnswer; ?>
                        </p>
                    <?php } else if(is_array($thisAnswer) && array_key_exists("answerList", $thisAnswer)) { ?>
                        <p>
                            <?php echo $answerKey ?>
                        </p>
                        <ol>
                            <?php foreach($thisAnswer as $thisAnswerList) { ?>
                                <?php foreach($thisAnswerList as $thisAnswerListItemKey => $thisAnswerListItem) { ?>
                                    <?php if(is_array($thisAnswerListItem)) { ?>
                                        <li>
                                            <?php echo $thisAnswerListItemKey; ?>
                                            <ol>
                                                <?php foreach($thisAnswerListItem as $thisListItemSubList) { ?>
                                                    <li>
                                                        <?php echo $thisListItemSubList; ?>
                                                    </li>
                                                <?php } ?>
                                            </ol>
                                        </li>
